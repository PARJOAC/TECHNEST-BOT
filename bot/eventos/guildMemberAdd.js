...
module.exports = {
    ...
    async execute(member, client) {
        ...
        .setColor("#fe81fe")
        .setTitle(`<a:peepopumpkindance:1287119445659091037> ¡Bienvenido a TechNest! ¡Nos Alegra que Estés Aquí ${member.username}! <a:peepopumpkindance:1287119445659091037>`)
